(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('hzjHipsterApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-hzjHipsterApp-error');
                var entityKey = httpResponse.headers('X-hzjHipsterApp-params');
                if (errorHeader) {
